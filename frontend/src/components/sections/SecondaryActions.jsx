    ...
    <section className="max-w-7xl mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-6 pb-20">
        ...
        <Link to="/stats" className="group">
          <div className="bg-slate-800 hover:bg-slate-700 p-6 rounded-lg border border-slate-700 hover:border-green-500/50 transition-all">
            <BarChart3 className="w-10 h-10 mb-3 text-green-500" />
        ...
        <Link to="/games" className="group">
          <div className="bg-slate-800 hover:bg-slate-700 p-6 rounded-lg border border-slate-700 hover:border-purple-500/50 transition-all">
            <History className="w-10 h-10 mb-3 text-purple-500" />
            <h3 className="text-lg font-bold mb-2">Game History</h3>
            <p className="text-slate-400 text-sm">Review past games and box scores</p>
          </div>
        </Link>
        ...
        <Link to="/settings" className="group">
          <div className="bg-slate-800 hover:bg-slate-700 p-6 rounded-lg border border-slate-700 hover:border-slate-500/50 transition-all">
            ...
            <p className="text-slate-400 text-sm">Preferences and configuration</p>
          </div>
        </Link>
